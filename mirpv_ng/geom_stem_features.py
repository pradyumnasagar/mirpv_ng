...
"""
Stem and helix feature extraction from RNA secondary structures.

This module provides functions to analyze base pairs and helical stems
from dot-bracket notation secondary structures.

Classes:
    StemRun: Dataclass representing a contiguous helix run.

Functions:
    get_basepairs: Parse dot-bracket to list of base pairs.
    get_hairpin_span: Get the genomic span of a hairpin structure.
    find_exact_stem_runs: Identify contiguous helical stems.
    compute_pair_composition: Calculate GC/AU/GU pair fractions.
    compute_helix_stats: Compute helix count, length statistics.
"""
