...
class MatureRanker:
    ...
    def predict_top1(
        ...
        for c in cands:
            ...
            c.features.setdefault("feat_len_is21", 1.0 if L == 21 else 0.0)
            c.features.setdefault("feat_len_is22", 1.0 if L == 22 else 0.0)
            c.features.setdefault("feat_len_is23", 1.0 if L == 23 else 0.0)
            c.features.setdefault("feat_len_is24", 1.0 if L == 24 else 0.0)
