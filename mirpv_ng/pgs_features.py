...
"""
Position-specific Geometric Scoring (PGS) features for miRPV-NG.

This module implements PGS motif detection and geometry scoring based on
characteristic miRNA sequence patterns:

- UGUG/UGU motifs in the apical loop
- Basal UG motifs near the 5' end
- CNNC-like motifs near the loop
- Stem length relative to ~40nt target

Functions:
    compute_pgs_features: Compute all PGS features for a sequence/structure.
"""
